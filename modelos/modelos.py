...
class Usuario(Base):
    ...
    id = Column(Integer, primary_key=True,comment='Identificador único tabla usuarios.')
    nombre = Column(String(100),nullable=False)
    usuario = Column(String(50),nullable=False)
    email = Column(String(255),nullable=False)
    contrasena_hash = Column(String(255),nullable=False,comment='Contraseña + Salt.')
    contrasena_salt = Column(String(255),nullable=False,comment='Salt única de la contraseña.')